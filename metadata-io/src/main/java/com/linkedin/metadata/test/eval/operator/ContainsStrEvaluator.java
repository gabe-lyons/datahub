 ...
 * if any string on the left hand side contains a substring of any string on the right hand side.
 */
public class ContainsStrEvaluator extends BaseOperatorEvaluator {
  ...
  public Object evaluate(ResolvedOperands resolvedOperands) throws InvalidOperandException {
    ...
    return operand2Values.stream().anyMatch(containee -> operand1Values.stream().anyMatch(container -> container.contains(containee)));
  }
