...
public class AssertionsSummaryUtilsTest {
  ...
  public void testRemoveAssertionFromFailingSummary() {
    ...
    AssertionsSummaryUtils.removeAssertionFromFailingSummary(TEST_ASSERTION_URN, summary);
    Assert.assertEquals(summary, mockAssertionsSummary(Collections.emptyList(),
        ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN))));
    ...
    summary = mockAssertionsSummary(
        ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN), buildAssertionSummaryDetails(TEST_ASSERTION_URN_2)),
        Collections.emptyList()
    );
    AssertionsSummaryUtils.removeAssertionFromFailingSummary(TEST_ASSERTION_URN, summary);
    Assert.assertEquals(summary, mockAssertionsSummary(ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN_2)),
        Collections.emptyList()));
  }
  ...
  public void testRemoveAssertionFromPassingSummary() {
    ...
    AssertionsSummaryUtils.removeAssertionFromPassingSummary(TEST_ASSERTION_URN, summary);
    Assert.assertEquals(summary, mockAssertionsSummary(ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN)),
        Collections.emptyList()));
  ...
  public void testAddAssertionToPassingSummary() {
    ...
    AssertionsSummaryUtils.addAssertionToPassingSummary(buildAssertionSummaryDetails(TEST_ASSERTION_URN_2), summary);
    AssertionsSummary expected = mockAssertionsSummary(Collections.emptyList(), ImmutableList.of(
        buildAssertionSummaryDetails(TEST_ASSERTION_URN),
        buildAssertionSummaryDetails(TEST_ASSERTION_URN_2)));
    Assert.assertEquals(new HashSet<>(summary.getPassingAssertionDetails()), new HashSet<>(expected.getPassingAssertionDetails())); // Set comparison
    Assert.assertEquals(new HashSet<>(summary.getFailingAssertionDetails()), new HashSet<>(expected.getFailingAssertionDetails())); // Set comparison
    ...
    AssertionsSummaryUtils.addAssertionToPassingSummary(buildAssertionSummaryDetails(TEST_ASSERTION_URN), summary);
    Assert.assertEquals(summary, mockAssertionsSummary(Collections.emptyList(),
        ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN))));
  ...
  public void testAddAssertionToFailingSummary() {
    ...
    AssertionsSummaryUtils.addAssertionToFailingSummary(buildAssertionSummaryDetails(TEST_ASSERTION_URN_2), summary);
    AssertionsSummary expected = mockAssertionsSummary(ImmutableList.of(
        buildAssertionSummaryDetails(TEST_ASSERTION_URN),
        buildAssertionSummaryDetails(TEST_ASSERTION_URN_2)),
        Collections.emptyList());
    Assert.assertEquals(new HashSet<>(summary.getPassingAssertionDetails()), new HashSet<>(expected.getPassingAssertionDetails())); // Set comparison
    ...
    AssertionsSummaryUtils.addAssertionToFailingSummary(buildAssertionSummaryDetails(TEST_ASSERTION_URN_2), summary);
    Assert.assertEquals(summary, mockAssertionsSummary(
        ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN_2)),
        ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN))));
    ...
    AssertionsSummaryUtils.addAssertionToFailingSummary(buildAssertionSummaryDetails(TEST_ASSERTION_URN), summary);
    Assert.assertEquals(summary, mockAssertionsSummary(ImmutableList.of(buildAssertionSummaryDetails(TEST_ASSERTION_URN)),
        Collections.emptyList()));
  ...
  private AssertionSummaryDetails buildAssertionSummaryDetails(Urn assertionUrn, String assertionType, Long lastResultAt) {
