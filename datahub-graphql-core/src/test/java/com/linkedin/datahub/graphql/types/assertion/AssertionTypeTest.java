...
public class AssertionTypeTest {
  ...
  private static final AssertionActions TEST_ASSERTION_ACTIONS = new AssertionActions()
    .setOnSuccess(new AssertionActionArray(ImmutableList.of(
        new AssertionAction().setType(AssertionActionType.RAISE_INCIDENT)
    )))
    .setOnFailure(new AssertionActionArray(ImmutableList.of(
  ...
  public void testBatchLoad() throws Exception {
    ...
    assertEquals(assertion.getActions().getOnSuccess().get(0).getType(),
        com.linkedin.datahub.graphql.generated.AssertionActionType.RAISE_INCIDENT);
    assertEquals(assertion.getActions().getOnFailure().get(0).getType(),
