...
public class ConnectionUtils {
  ...
  /**
   * Returns true if the user is able to read and or write connection between
   * DataHub and external platforms.
   */
  public static boolean canManageConnections(@Nonnull QueryContext context) {
    final DisjunctivePrivilegeGroup orPrivilegeGroups = new DisjunctivePrivilegeGroup(
        ImmutableList.of(new ConjunctivePrivilegeGroup(ImmutableList.of(PoliciesConfig.MANAGE_CONNECTIONS_PRIVILEGE.getType()))));
